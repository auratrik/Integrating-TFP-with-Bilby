...
class Model(object):
	...
	if  kwargs.get('jax') == True:
	    # Your code here
            ...
            XP = LinTransform(poly,key: pred[i] for i, key in enumerate(self.regressor_keys)}
            y_pred = transform3(poly,XP)
	else 
            y_pred = {key: pred[i] for i, key in enumerate(self.regressor_keys)}
